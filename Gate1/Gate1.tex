...
\begin{figure}[!h]
 \centering
 \includegraphics[width=\columnwidth]{xt.png}
 \caption{A base-band signal with bandwidth 10 kHz}
\end{figure}
\begin{figure}[!h]
 \centering
 \includegraphics[width=\columnwidth]{xscaled.png}
 \caption{$x\brak{1+\frac{t}{2}}$}
\end{figure}
\begin{figure}[!h]
 \centering
 \includegraphics[width=\columnwidth]{yt.png}
 \caption{$y\brak{t}$}
\end{figure}
\begin{figure}[!h]
 \centering
 \includegraphics[width=\columnwidth]{freq.png}
 \caption{Fourier transform of $y\brak{t}$.The max frequency is 15 kHz}
\end{figure}
\end{document}
