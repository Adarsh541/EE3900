...
\section{Solution}
\begin{align}
 \text{Area of a } \triangle ABC &= \frac{1}{2}\norm{\vec{AB} \times \vec{AC}}\\
 &= \frac{1}{2} \brak{AB \times AC}Sin\brak{\phi}   
\end{align}
where $\phi$ is angle between vectors $\vec{AB}$ and $\vec{AC}$
\begin{align}
    \frac{\text{area of } \triangle ADE}{\text{area of } \triangle ABC}&=\frac{\brak{AD \times AE}Sin\brak{\phi}}{\brak{AB \times AC}Sin\brak{\phi}}\\
    &= \frac{1}{16}
\end{align}
\begin{figure}[!h]
 \centering
