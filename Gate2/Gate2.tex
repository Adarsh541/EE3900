...
\begin{align}
  \text{Input}&:x\brak{t}\\
  \text{Output}&:y\brak{t}=y_1\brak{t}+y_2\brak{t}\label{f}
\end{align}
\begin{center}
\begin{circuitikz}[american voltages]
\draw (0,0) to [R,l=$2R$](2.5,0) to [R,l=$R$](2.5,2.5) to [short,i_=$i_2$](2.5,3) to [L,l=$L$](0,3) to [L,l=$L$](-2.5,3) to [R,l=$R$](-2.5,1) (-2.5,0) to [short,](0,0) to [american voltage source,l_=$x\brak{t}$](0,3);
\draw (-3.5,0) to [short,*-](-2.5,0);
\draw (-3.5,3) to [short,*-](-2.5,3);
\draw  (3.3,0) to [short,*-](2.5,0);
\draw (3.3,3) to [short,*-](2.5,3);
